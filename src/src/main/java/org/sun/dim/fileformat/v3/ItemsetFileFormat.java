...
public final class ItemsetFileFormat {
  ...
  public static final class VertexFMT extends
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return ItemsetFileFormat.internal_static_org_sun_dim_fileformat_v3_VertexFMT_descriptor;
    }
    
    protected FieldAccessorTable
        internalGetFieldAccessorTable() {
      return ItemsetFileFormat.internal_static_org_sun_dim_fileformat_v3_VertexFMT_fieldAccessorTable;
    }
    ...
    public static VertexFMT parseFrom(
    ...
    public static VertexFMT parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return newBuilder().mergeFrom(data).buildParsed();
    }
    public static VertexFMT parseFrom(
    ...
    public static VertexFMT parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static VertexFMT parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static VertexFMT parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      Builder builder = newBuilder();
    ...
    public static Builder newBuilder(VertexFMT prototype) {
    ...
    public static final class Builder extends
      ...
      public com.google.protobuf.Descriptors.Descriptor
        ...
        return VertexFMT.getDescriptor();
      }
      
      public VertexFMT getDefaultInstanceForType() {
        return VertexFMT.getDefaultInstance();
      }
      
      public VertexFMT build() {
        VertexFMT result = buildPartial();
      ...
      public VertexFMT buildPartial() {
        VertexFMT result = new VertexFMT(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof VertexFMT) {
          return mergeFrom((VertexFMT)other);
        } else {
      ...
      public Builder mergeFrom(VertexFMT other) {
        if (other == VertexFMT.getDefaultInstance()) return this;
        if (other.hasId()) {
          setId(other.getId());
        }
  ...
  public static final class EdgeFMT extends
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return ItemsetFileFormat.internal_static_org_sun_dim_fileformat_v3_EdgeFMT_descriptor;
    }
    
    protected FieldAccessorTable
        internalGetFieldAccessorTable() {
      return ItemsetFileFormat.internal_static_org_sun_dim_fileformat_v3_EdgeFMT_fieldAccessorTable;
    }
    ...
    public static EdgeFMT parseFrom(
        com.google.protobuf.ByteString data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return newBuilder().mergeFrom(data).buildParsed();
    }
    ...
    public static EdgeFMT parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return newBuilder().mergeFrom(data).buildParsed();
    }
    public static EdgeFMT parseFrom(
    ...
    public static EdgeFMT parseFrom(java.io.InputStream input)
        throws java.io.IOException {
      return newBuilder().mergeFrom(input).buildParsed();
    }
    public static EdgeFMT parseFrom(
    ...
    public static EdgeFMT parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      Builder builder = newBuilder();
      if (builder.mergeDelimitedFrom(input)) {
        return builder.buildParsed();
    ...
    public static EdgeFMT parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      Builder builder = newBuilder();
    ...
    public static Builder newBuilder() { return Builder.create(); }
    public Builder newBuilderForType() { return newBuilder(); }
    public static Builder newBuilder(EdgeFMT prototype) {
      return newBuilder().mergeFrom(prototype);
    }
    public Builder toBuilder() { return newBuilder(this); }
    ...
    public static final class Builder extends
      ...
      public com.google.protobuf.Descriptors.Descriptor
          getDescriptorForType() {
        return EdgeFMT.getDescriptor();
      }
      
      public EdgeFMT getDefaultInstanceForType() {
        return EdgeFMT.getDefaultInstance();
      }
      
      public EdgeFMT build() {
        EdgeFMT result = buildPartial();
        if (!result.isInitialized()) {
          throw newUninitializedMessageException(result);
        }
        return result;
      ...
      public EdgeFMT buildPartial() {
        EdgeFMT result = new EdgeFMT(this);
        int from_bitField0_ = bitField0_;
        int to_bitField0_ = 0;
        if (((from_bitField0_ & 0x00000001) == 0x00000001)) {
          to_bitField0_ |= 0x00000001;
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof EdgeFMT) {
          return mergeFrom((EdgeFMT)other);
        } else {
          super.mergeFrom(other);
          return this;
        }
      ...
      public Builder mergeFrom(EdgeFMT other) {
        if (other == EdgeFMT.getDefaultInstance()) return this;
        if (other.hasSource()) {
  ...
  public static final class TransactionFMT extends
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return ItemsetFileFormat.internal_static_org_sun_dim_fileformat_v3_TransactionFMT_descriptor;
    }
    
    protected FieldAccessorTable
        internalGetFieldAccessorTable() {
      return ItemsetFileFormat.internal_static_org_sun_dim_fileformat_v3_TransactionFMT_fieldAccessorTable;
    }
    ...
    private java.util.List<Integer> items_;
    ...
    public static TransactionFMT parseFrom(
        com.google.protobuf.ByteString data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return newBuilder().mergeFrom(data).buildParsed();
    }
    ...
    public static TransactionFMT parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return newBuilder().mergeFrom(data).buildParsed();
    }
    public static TransactionFMT parseFrom(
    ...
    public static TransactionFMT parseFrom(java.io.InputStream input)
        throws java.io.IOException {
      return newBuilder().mergeFrom(input).buildParsed();
    }
    public static TransactionFMT parseFrom(
    ...
    public static TransactionFMT parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      Builder builder = newBuilder();
      if (builder.mergeDelimitedFrom(input)) {
        return builder.buildParsed();
    ...
    public static TransactionFMT parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      Builder builder = newBuilder();
    ...
    public static Builder newBuilder() { return Builder.create(); }
    public Builder newBuilderForType() { return newBuilder(); }
    public static Builder newBuilder(TransactionFMT prototype) {
      return newBuilder().mergeFrom(prototype);
    }
    public Builder toBuilder() { return newBuilder(this); }
    ...
    public static final class Builder extends
      ...
      public com.google.protobuf.Descriptors.Descriptor
          getDescriptorForType() {
        return TransactionFMT.getDescriptor();
      }
      
      public TransactionFMT getDefaultInstanceForType() {
        return TransactionFMT.getDefaultInstance();
      }
      
      public TransactionFMT build() {
        TransactionFMT result = buildPartial();
        if (!result.isInitialized()) {
          throw newUninitializedMessageException(result);
        }
        return result;
      ...
      private TransactionFMT buildParsed()
          throws com.google.protobuf.InvalidProtocolBufferException {
        TransactionFMT result = buildPartial();
        if (!result.isInitialized()) {
          throw newUninitializedMessageException(
      ...
      public TransactionFMT buildPartial() {
        TransactionFMT result = new TransactionFMT(this);
        int from_bitField0_ = bitField0_;
        int to_bitField0_ = 0;
        if (((from_bitField0_ & 0x00000001) == 0x00000001)) {
          to_bitField0_ |= 0x00000001;
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof TransactionFMT) {
          return mergeFrom((TransactionFMT)other);
        } else {
          super.mergeFrom(other);
          return this;
        }
      ...
      public Builder mergeFrom(TransactionFMT other) {
        if (other == TransactionFMT.getDefaultInstance()) return this;
      ...
      // repeated int32 items = 3;
      private java.util.List<Integer> items_ = java.util.Collections.emptyList();;
      private void ensureItemsIsMutable() {
        if (!((bitField0_ & 0x00000004) == 0x00000004)) {
          items_ = new java.util.ArrayList<Integer>(items_);
          bitField0_ |= 0x00000004;
         }
      }
      public java.util.List<Integer>
  ...
  public interface TransactionListFMTOrBuilder
    ...
    java.util.List<TransactionFMT>
        getTransactionsList();
    TransactionFMT getTransactions(int index);
    int getTransactionsCount();
    java.util.List<? extends TransactionFMTOrBuilder>
        getTransactionsOrBuilderList();
    TransactionFMTOrBuilder getTransactionsOrBuilder(
        int index);
  }
  public static final class TransactionListFMT extends
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return ItemsetFileFormat.internal_static_org_sun_dim_fileformat_v3_TransactionListFMT_descriptor;
    }
    
    protected FieldAccessorTable
        internalGetFieldAccessorTable() {
      return ItemsetFileFormat.internal_static_org_sun_dim_fileformat_v3_TransactionListFMT_fieldAccessorTable;
    }
    
    // repeated .org.sun.dim.fileformat.v3.TransactionFMT transactions = 1;
    public static final int TRANSACTIONS_FIELD_NUMBER = 1;
    private java.util.List<TransactionFMT> transactions_;
    public java.util.List<TransactionFMT> getTransactionsList() {
      return transactions_;
    }
    public java.util.List<? extends TransactionFMTOrBuilder>
        getTransactionsOrBuilderList() {
      return transactions_;
    }
    ...
    public TransactionFMT getTransactions(int index) {
      return transactions_.get(index);
    }
    public TransactionFMTOrBuilder getTransactionsOrBuilder(
        int index) {
      return transactions_.get(index);
    }
    ...
    public static TransactionListFMT parseFrom(
        com.google.protobuf.ByteString data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return newBuilder().mergeFrom(data).buildParsed();
    }
    ...
    public static TransactionListFMT parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return newBuilder().mergeFrom(data).buildParsed();
    }
    public static TransactionListFMT parseFrom(
    ...
    public static TransactionListFMT parseFrom(java.io.InputStream input)
        throws java.io.IOException {
      return newBuilder().mergeFrom(input).buildParsed();
    }
    public static TransactionListFMT parseFrom(
    ...
    public static TransactionListFMT parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      Builder builder = newBuilder();
      if (builder.mergeDelimitedFrom(input)) {
        return builder.buildParsed();
    ...
    public static TransactionListFMT parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      Builder builder = newBuilder();
    ...
    public static Builder newBuilder() { return Builder.create(); }
    public Builder newBuilderForType() { return newBuilder(); }
    public static Builder newBuilder(TransactionListFMT prototype) {
      return newBuilder().mergeFrom(prototype);
    }
    public Builder toBuilder() { return newBuilder(this); }
    ...
    public static final class Builder extends
      ...
      public com.google.protobuf.Descriptors.Descriptor
          getDescriptorForType() {
        return TransactionListFMT.getDescriptor();
      }
      
      public TransactionListFMT getDefaultInstanceForType() {
        return TransactionListFMT.getDefaultInstance();
      }
      
      public TransactionListFMT build() {
        TransactionListFMT result = buildPartial();
        if (!result.isInitialized()) {
          throw newUninitializedMessageException(result);
        }
        return result;
      ...
      private TransactionListFMT buildParsed()
          throws com.google.protobuf.InvalidProtocolBufferException {
        TransactionListFMT result = buildPartial();
        if (!result.isInitialized()) {
          throw newUninitializedMessageException(
      ...
      public TransactionListFMT buildPartial() {
        TransactionListFMT result = new TransactionListFMT(this);
        int from_bitField0_ = bitField0_;
        if (transactionsBuilder_ == null) {
          if (((bitField0_ & 0x00000001) == 0x00000001)) {
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof TransactionListFMT) {
          return mergeFrom((TransactionListFMT)other);
        } else {
          super.mergeFrom(other);
          return this;
        }
      ...
      public Builder mergeFrom(TransactionListFMT other) {
        if (other == TransactionListFMT.getDefaultInstance()) return this;
        if (transactionsBuilder_ == null) {
      ...
      public Builder mergeFrom(
        ...
        while (true) {
          ...
          switch (tag) {
            ...
            case 10: {
              TransactionFMT.Builder subBuilder = TransactionFMT.newBuilder();
      ...
      private void ensureTransactionsIsMutable() {
        if (!((bitField0_ & 0x00000001) == 0x00000001)) {
          transactions_ = new java.util.ArrayList<TransactionFMT>(transactions_);
          bitField0_ |= 0x00000001;
         }
      }
      
      private com.google.protobuf.RepeatedFieldBuilder<
          TransactionFMT, TransactionFMT.Builder, TransactionFMTOrBuilder> transactionsBuilder_;
      ...
      public Builder setTransactions(
          int index, TransactionFMT value) {
        if (transactionsBuilder_ == null) {
          if (value == null) {
      ...
      public Builder setTransactions(
          int index, TransactionFMT.Builder builderForValue) {
        if (transactionsBuilder_ == null) {
          ensureTransactionsIsMutable();
      ...
      public Builder addTransactions(TransactionFMT value) {
        if (transactionsBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
      ...
      public Builder addTransactions(
          TransactionFMT.Builder builderForValue) {
        if (transactionsBuilder_ == null) {
          ensureTransactionsIsMutable();
      ...
      public Builder addAllTransactions(
          Iterable<? extends TransactionFMT> values) {
        if (transactionsBuilder_ == null) {
          ensureTransactionsIsMutable();
      ...
      public TransactionFMT.Builder getTransactionsBuilder(
          int index) {
      ...
      public TransactionFMT.Builder addTransactionsBuilder() {
        return getTransactionsFieldBuilder().addBuilder(
            TransactionFMT.getDefaultInstance());
      }
      public TransactionFMT.Builder addTransactionsBuilder(
          int index) {
        return getTransactionsFieldBuilder().addBuilder(
            index, TransactionFMT.getDefaultInstance());
      }
      public java.util.List<TransactionFMT.Builder>
           getTransactionsBuilderList() {
        return getTransactionsFieldBuilder().getBuilderList();
      }
      private com.google.protobuf.RepeatedFieldBuilder<
          TransactionFMT, TransactionFMT.Builder, TransactionFMTOrBuilder>
          getTransactionsFieldBuilder() {
        if (transactionsBuilder_ == null) {
  ...
  public interface TransactionDBFMTOrBuilder
    ...
    java.util.List<EdgeFMT>
        getEdgesList();
    EdgeFMT getEdges(int index);
    int getEdgesCount();
    java.util.List<? extends EdgeFMTOrBuilder>
        getEdgesOrBuilderList();
    EdgeFMTOrBuilder getEdgesOrBuilder(
        int index);
    
    // repeated .org.sun.dim.fileformat.v3.VertexFMT vertices = 5;
    java.util.List<VertexFMT>
        getVerticesList();
    VertexFMT getVertices(int index);
    int getVerticesCount();
    java.util.List<? extends VertexFMTOrBuilder>
        getVerticesOrBuilderList();
    VertexFMTOrBuilder getVerticesOrBuilder(
        int index);
    
    // repeated .org.sun.dim.fileformat.v3.TransactionFMT vertex_transactions = 6;
    java.util.List<TransactionFMT>
        getVertexTransactionsList();
    TransactionFMT getVertexTransactions(int index);
    int getVertexTransactionsCount();
    java.util.List<? extends TransactionFMTOrBuilder>
        getVertexTransactionsOrBuilderList();
    TransactionFMTOrBuilder getVertexTransactionsOrBuilder(
        int index);
    ...
    java.util.List<TransactionListFMT>
        getListsList();
    TransactionListFMT getLists(int index);
    int getListsCount();
    java.util.List<? extends TransactionListFMTOrBuilder>
        getListsOrBuilderList();
    TransactionListFMTOrBuilder getListsOrBuilder(
        int index);
  }
  public static final class TransactionDBFMT extends
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return ItemsetFileFormat.internal_static_org_sun_dim_fileformat_v3_TransactionDBFMT_descriptor;
    }
    
    protected FieldAccessorTable
        internalGetFieldAccessorTable() {
      return ItemsetFileFormat.internal_static_org_sun_dim_fileformat_v3_TransactionDBFMT_fieldAccessorTable;
    }
    
    private int bitField0_;
    // repeated .org.sun.dim.fileformat.v3.EdgeFMT edges = 1;
    public static final int EDGES_FIELD_NUMBER = 1;
    private java.util.List<EdgeFMT> edges_;
    public java.util.List<EdgeFMT> getEdgesList() {
      return edges_;
    }
    public java.util.List<? extends EdgeFMTOrBuilder>
        getEdgesOrBuilderList() {
      return edges_;
    }
    ...
    public EdgeFMT getEdges(int index) {
      return edges_.get(index);
    }
    public EdgeFMTOrBuilder getEdgesOrBuilder(
        int index) {
      return edges_.get(index);
    }
    ...
    private java.util.List<VertexFMT> vertices_;
    public java.util.List<VertexFMT> getVerticesList() {
      return vertices_;
    }
    public java.util.List<? extends VertexFMTOrBuilder>
        getVerticesOrBuilderList() {
      return vertices_;
    }
    ...
    public VertexFMT getVertices(int index) {
      return vertices_.get(index);
    }
    public VertexFMTOrBuilder getVerticesOrBuilder(
        int index) {
      return vertices_.get(index);
    }
    ...
    private java.util.List<TransactionFMT> vertexTransactions_;
    public java.util.List<TransactionFMT> getVertexTransactionsList() {
    ...
    public TransactionFMT getVertexTransactions(int index) {
      return vertexTransactions_.get(index);
    }
    public TransactionFMTOrBuilder getVertexTransactionsOrBuilder(
        int index) {
      return vertexTransactions_.get(index);
    }
    ...
    private java.util.List<TransactionListFMT> lists_;
    public java.util.List<TransactionListFMT> getListsList() {
      return lists_;
    }
    public java.util.List<? extends TransactionListFMTOrBuilder>
        getListsOrBuilderList() {
      return lists_;
    }
    ...
    public TransactionListFMT getLists(int index) {
      return lists_.get(index);
    }
    public TransactionListFMTOrBuilder getListsOrBuilder(
        int index) {
      return lists_.get(index);
    }
    ...
    public static TransactionDBFMT parseFrom(
        com.google.protobuf.ByteString data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return newBuilder().mergeFrom(data).buildParsed();
    }
    ...
    public static TransactionDBFMT parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return newBuilder().mergeFrom(data).buildParsed();
    }
    public static TransactionDBFMT parseFrom(
    ...
    public static TransactionDBFMT parseFrom(java.io.InputStream input)
        throws java.io.IOException {
      return newBuilder().mergeFrom(input).buildParsed();
    }
    public static TransactionDBFMT parseFrom(
    ...
    public static TransactionDBFMT parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      Builder builder = newBuilder();
      if (builder.mergeDelimitedFrom(input)) {
        return builder.buildParsed();
    ...
    public static TransactionDBFMT parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      Builder builder = newBuilder();
    ...
    public static Builder newBuilder() { return Builder.create(); }
    public Builder newBuilderForType() { return newBuilder(); }
    public static Builder newBuilder(TransactionDBFMT prototype) {
      return newBuilder().mergeFrom(prototype);
    }
    public Builder toBuilder() { return newBuilder(this); }
    ...
    public static final class Builder extends
      ...
      public com.google.protobuf.Descriptors.Descriptor
          getDescriptorForType() {
        return TransactionDBFMT.getDescriptor();
      }
      
      public TransactionDBFMT getDefaultInstanceForType() {
        return TransactionDBFMT.getDefaultInstance();
      }
      
      public TransactionDBFMT build() {
        TransactionDBFMT result = buildPartial();
        if (!result.isInitialized()) {
          throw newUninitializedMessageException(result);
        }
        return result;
      ...
      private TransactionDBFMT buildParsed()
          throws com.google.protobuf.InvalidProtocolBufferException {
        TransactionDBFMT result = buildPartial();
        if (!result.isInitialized()) {
          throw newUninitializedMessageException(
      ...
      public TransactionDBFMT buildPartial() {
        TransactionDBFMT result = new TransactionDBFMT(this);
        int from_bitField0_ = bitField0_;
        int to_bitField0_ = 0;
        if (edgesBuilder_ == null) {
          if (((bitField0_ & 0x00000001) == 0x00000001)) {
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof TransactionDBFMT) {
          return mergeFrom((TransactionDBFMT)other);
        } else {
          super.mergeFrom(other);
          return this;
        }
      ...
      public Builder mergeFrom(TransactionDBFMT other) {
        if (other == TransactionDBFMT.getDefaultInstance()) return this;
        if (edgesBuilder_ == null) {
      ...
      public Builder mergeFrom(
        ...
        while (true) {
          ...
          switch (tag) {
            ...
            case 10: {
              EdgeFMT.Builder subBuilder = EdgeFMT.newBuilder();
              input.readMessage(subBuilder, extensionRegistry);
              addEdges(subBuilder.buildPartial());
              break;
            }
            case 18: {
              TransactionListFMT.Builder subBuilder = TransactionListFMT.newBuilder();
              input.readMessage(subBuilder, extensionRegistry);
            ...
            case 42: {
              VertexFMT.Builder subBuilder = VertexFMT.newBuilder();
              input.readMessage(subBuilder, extensionRegistry);
      ...
      private void ensureEdgesIsMutable() {
        if (!((bitField0_ & 0x00000001) == 0x00000001)) {
          edges_ = new java.util.ArrayList<EdgeFMT>(edges_);
          bitField0_ |= 0x00000001;
         }
      }
      
      private com.google.protobuf.RepeatedFieldBuilder<
          EdgeFMT, EdgeFMT.Builder, EdgeFMTOrBuilder> edgesBuilder_;
      ...
      public Builder setEdges(
          int index, EdgeFMT.Builder builderForValue) {
        if (edgesBuilder_ == null) {
          ensureEdgesIsMutable();
      ...
      public Builder addEdges(EdgeFMT value) {
        if (edgesBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
      ...
      public Builder addEdges(
          EdgeFMT.Builder builderForValue) {
        if (edgesBuilder_ == null) {
          ensureEdgesIsMutable();
      ...
      public Builder addAllEdges(
          Iterable<? extends EdgeFMT> values) {
        if (edgesBuilder_ == null) {
          ensureEdgesIsMutable();
      ...
      public EdgeFMT.Builder getEdgesBuilder(
          int index) {
      ...
      public EdgeFMT.Builder addEdgesBuilder() {
        return getEdgesFieldBuilder().addBuilder(
            EdgeFMT.getDefaultInstance());
      }
      public EdgeFMT.Builder addEdgesBuilder(
          int index) {
        return getEdgesFieldBuilder().addBuilder(
            index, EdgeFMT.getDefaultInstance());
      }
      public java.util.List<EdgeFMT.Builder>
           getEdgesBuilderList() {
        return getEdgesFieldBuilder().getBuilderList();
      }
      private com.google.protobuf.RepeatedFieldBuilder<
          EdgeFMT, EdgeFMT.Builder, EdgeFMTOrBuilder>
          getEdgesFieldBuilder() {
        if (edgesBuilder_ == null) {
      ...
      private void ensureVerticesIsMutable() {
        if (!((bitField0_ & 0x00000002) == 0x00000002)) {
          vertices_ = new java.util.ArrayList<VertexFMT>(vertices_);
          bitField0_ |= 0x00000002;
         }
      }
      
      private com.google.protobuf.RepeatedFieldBuilder<
          VertexFMT, VertexFMT.Builder, VertexFMTOrBuilder> verticesBuilder_;
      ...
      public Builder setVertices(
          int index, VertexFMT.Builder builderForValue) {
        if (verticesBuilder_ == null) {
          ensureVerticesIsMutable();
      ...
      public Builder addVertices(VertexFMT value) {
        if (verticesBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
      ...
      public Builder addVertices(
          VertexFMT.Builder builderForValue) {
        if (verticesBuilder_ == null) {
          ensureVerticesIsMutable();
      ...
      public Builder addAllVertices(
          Iterable<? extends VertexFMT> values) {
        if (verticesBuilder_ == null) {
          ensureVerticesIsMutable();
      ...
      public VertexFMT.Builder getVerticesBuilder(
          int index) {
      ...
      public VertexFMT.Builder addVerticesBuilder() {
        return getVerticesFieldBuilder().addBuilder(
            VertexFMT.getDefaultInstance());
      }
      public VertexFMT.Builder addVerticesBuilder(
          int index) {
        return getVerticesFieldBuilder().addBuilder(
            index, VertexFMT.getDefaultInstance());
      }
      public java.util.List<VertexFMT.Builder>
           getVerticesBuilderList() {
        return getVerticesFieldBuilder().getBuilderList();
      }
      private com.google.protobuf.RepeatedFieldBuilder<
          VertexFMT, VertexFMT.Builder, VertexFMTOrBuilder>
          getVerticesFieldBuilder() {
        if (verticesBuilder_ == null) {
      ...
      private void ensureVertexTransactionsIsMutable() {
        if (!((bitField0_ & 0x00000004) == 0x00000004)) {
          vertexTransactions_ = new java.util.ArrayList<TransactionFMT>(vertexTransactions_);
          bitField0_ |= 0x00000004;
         }
      }
      
      private com.google.protobuf.RepeatedFieldBuilder<
          TransactionFMT, TransactionFMT.Builder, TransactionFMTOrBuilder> vertexTransactionsBuilder_;
      ...
      public Builder addVertexTransactions(TransactionFMT value) {
        if (vertexTransactionsBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
      ...
      public TransactionFMT.Builder getVertexTransactionsBuilder(
          int index) {
      ...
      public TransactionFMT.Builder addVertexTransactionsBuilder() {
      ...
      private void ensureListsIsMutable() {
        if (!((bitField0_ & 0x00000020) == 0x00000020)) {
          lists_ = new java.util.ArrayList<TransactionListFMT>(lists_);
          bitField0_ |= 0x00000020;
         }
      }
      
      private com.google.protobuf.RepeatedFieldBuilder<
          TransactionListFMT, TransactionListFMT.Builder, TransactionListFMTOrBuilder> listsBuilder_;
      ...
      public Builder setLists(
          int index, TransactionListFMT value) {
        if (listsBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
      ...
      public Builder setLists(
          int index, TransactionListFMT.Builder builderForValue) {
        if (listsBuilder_ == null) {
          ensureListsIsMutable();
      ...
      public Builder addLists(TransactionListFMT value) {
        if (listsBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
      ...
      public Builder addLists(
          TransactionListFMT.Builder builderForValue) {
        if (listsBuilder_ == null) {
          ensureListsIsMutable();
      ...
      public Builder addAllLists(
          Iterable<? extends TransactionListFMT> values) {
        if (listsBuilder_ == null) {
          ensureListsIsMutable();
      ...
      public TransactionListFMT.Builder getListsBuilder(
          int index) {
      ...
      public TransactionListFMT.Builder addListsBuilder() {
        return getListsFieldBuilder().addBuilder(
            TransactionListFMT.getDefaultInstance());
      }
      public TransactionListFMT.Builder addListsBuilder(
          int index) {
        return getListsFieldBuilder().addBuilder(
            index, TransactionListFMT.getDefaultInstance());
      }
      public java.util.List<TransactionListFMT.Builder>
           getListsBuilderList() {
        return getListsFieldBuilder().getBuilderList();
      }
      private com.google.protobuf.RepeatedFieldBuilder<
          TransactionListFMT, TransactionListFMT.Builder, TransactionListFMTOrBuilder>
          getListsFieldBuilder() {
        if (listsBuilder_ == null) {
        ...
        public com.google.protobuf.ExtensionRegistry assignDescriptors(
          ...
          internal_static_org_sun_dim_fileformat_v3_TransactionListFMT_fieldAccessorTable = new
            com.google.protobuf.GeneratedMessage.FieldAccessorTable(
              ...
              TransactionListFMT.class,
              TransactionListFMT.Builder.class);
          internal_static_org_sun_dim_fileformat_v3_TransactionDBFMT_descriptor =
            getDescriptor().getMessageTypes().get(4);
          internal_static_org_sun_dim_fileformat_v3_TransactionDBFMT_fieldAccessorTable = new
            com.google.protobuf.GeneratedMessage.FieldAccessorTable(
              internal_static_org_sun_dim_fileformat_v3_TransactionDBFMT_descriptor,
              new String[] { "Edges", "Vertices", "VertexTransactions", "PositiveSupport", "NegativeSupport", "Lists", },
              TransactionDBFMT.class,
              TransactionDBFMT.Builder.class);
          return null;
        }
      };
